...
function Personal() {
  const professorData = {
    ...
    researchTopics: ['Finite temperature field theory', 'Lattice QCD', 'QCD at finite temperature and density'],
    phdInstitute: 'Ph.D. 2010, Stony Brook',
    contact: {
      officeNo: 'B2-03',
      telephone: '+91-80-2293-3596',
      email: 'prasadhegde@iisc.ac.in',
    },
    publicationLink: "https://inspirehep.net/literature?sort=mostrecent&size=25&page=1&q=find%20a%20Hegde%2CP",
  };
  ...
  return (
    <div className="professor-page">
      ...
      <div className="professor-container">
        <img src={ph} alt={professorData.name} className="professor-image" />
