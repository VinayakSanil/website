...
function Personal() {
  const professorData = {
    name: 'ROMESH KAUL, FASc, FNA',
    position: 'Professor',
    researchTopics: ['Particle Physics', 'Quantum Field Theory','Gravity'],
    phdInstitute: 'Ph.D. 1976, Delhi',
    contact: {
      officeNo: 'B2-05',
      telephone: '+91-80-2293-2845',
      email: 'romeshkaul@iisc.ac.in',
    },
    publicationLink: "https://inspirehep.net/authors/1003426?ui-citation-summary=true",
  };
  ...
  return (
    <div className="professor-page">
      ...
      <div className="professor-container">
        <img src={rk} alt={professorData.name} className="professor-image" />
